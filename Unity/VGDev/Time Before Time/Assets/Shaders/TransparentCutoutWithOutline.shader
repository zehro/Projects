Shader "TransparentCutoutWithOutline"
{
	Properties 
	{
_Color("_Color", 2D) = "gray" {}
_HighlightColor("_HighlightColor", Color) = (1,0,0,1)
_Power("_Power", Range(0,1) ) = 1
_AlphaMult("_AlphaMult", Range(0,20) ) = 20
_ColorTint("_ColorTint", Color) = (0.6029412,0.8192698,1,1)
